...
console.log(
	process.env.ME_CONFIG_BASICAUTH_PASSWORD,
...
module.exports = {
	mongodb: {
       ...
       */
			{
				database: process.env.ME_CONFIG_MONGODB_AUTH_DATABASE || 'U_API' || mongo.db ,
	...
	basicAuth: {
		...
		password: getFileEnv(basicAuthPassword) || 'secure@#1234',
	},
